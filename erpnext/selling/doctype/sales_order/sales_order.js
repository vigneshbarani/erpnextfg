        ...
        frappe.call({
            ...
            callback: function (data) {
                frappe.model.set_value(frm.doctype,
                    frm.docname, "Warehouse",
                    data.message.set_warehouse);
              }
        })
    }
});
...
//Set default warehoue based on company
// cur_frm.add_fetch("company", "default_warehouse_for_sales_return", "set_warehouse");

// frappe.ui.form.on("Sales Order Item", "item_code", function(frm, cdt, cdn) {
//   if (!frm.cur_grid.doc.warehouse) {
//     frm.cur_grid.doc.warehouse = frm.doc.set_warehouse;
